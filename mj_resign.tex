...
\def\Who{Manoj XXX} % Your name
\def\What{, RA} % Your title
\def\Where{FOSSEE, Department of Chemical Engineering} % Your department/institution
\def\Address{IIT Bombay} % Your address
\def\CityZip{Powai 400076} % Your city, zip code, country, etc
\def\Email{E-mail: mjxxx@abc.com} % Your email address
\def\TEL{Phone: (000) 111-1111} % Your phone number
\def\URL{URL: http://www.myname.com} % Your URL
...
\Large\hspace{1.5in}FOSSEE  \hfill ~\\[0.05in] % First line of institution name, adjust hspace if your logo is wide
\hspace{1.5in}IIT Bombay \hfill \normalsize % Second line of institution name, adjust hspace if your logo is wide
...
Over the past year working with FOSSEE, I have not only learned a lot about the technical aspects of a major software development project, but also about the tremendous scope of sound technical expertise in industry.

I believe I've been able to contribute positively to the project, and the time has come for me to move on to another challenge. I don't have any standing offer from any company or institution, but I will look for the best outlet for my enthusiasm for technology.

I would still like to be associated with Sandhi and Linux\_on\_Aakash project.

Please consider this my formal resignation letter, and let me know when we can have a discussion about making this smooth transition.
